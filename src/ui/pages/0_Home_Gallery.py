...
from src.ui.components import badge_row, recruiter_demo_expander
...
try:
    from src.ui.api_client import get_rag_status, list_assistants
            ...
            if a_type == "rag":
                try:
                    ...
                    if rag_info.get("has_documents"):
                        ...
                        status_html = '<span style="color:#F59E0B;font-weight:600;">📄 Needs documents</span>'
                        is_ready = False
                except Exception:
